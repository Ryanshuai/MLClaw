...
```bash
python <mlclaw_root>/scripts/repro/repro.py check --project {PROJECT} --run <stage>/<run_id>
```
...
```bash
python <mlclaw_root>/scripts/repro/repro.py open --project {PROJECT} \
...
```bash
python <mlclaw_root>/scripts/repro/repro.py trial --project {PROJECT} \
    --session <sid> --run evaluation/<run_id>
python <mlclaw_root>/scripts/repro/repro.py band --project {PROJECT} --session <sid>
```
...
```bash
python <mlclaw_root>/scripts/repro/repro.py trial --project {PROJECT} --session <sid> \
...
```bash
python <mlclaw_root>/scripts/repro/repro.py attribute --project {PROJECT} --session <sid>
```
...
```bash
python <mlclaw_root>/scripts/repro/repro.py close --project {PROJECT} --session <sid> \
