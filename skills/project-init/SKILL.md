...
The unified contract (see `<mlclaw_root>/references/layout.md` "Code Source Resolution") is `code_dir = stages/{stage}/code/_source if exists else stages/{stage}/code`. Per source mode:
